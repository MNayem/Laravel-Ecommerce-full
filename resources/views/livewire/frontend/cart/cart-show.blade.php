                                        ...
                                        <div class="col-md-2 col-7 my-auto">
                                            <div class="quantity">
                                                <div class="input-group">
                                                    <button type="button" wire:loading.attr="disabled" wire:click="decreamentQuantity({{ $cartItem->id }})" class="btn btn1"><i class="fa fa-minus"></i></button>
                                                    <input type="text" value="{{ $cartItem->quantity }}" readonly class="input-quantity" />
                                                    <button type="button" wire:loading.attr="disabled" wire:click="increamentQuantity({{ $cartItem->id }})" class="btn btn1"><i class="fa fa-plus"></i></button>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-1 my-auto">
            ...
            <div class="row">
                ...
                <div class="col-md-4 mt-3">
                    <div class="shadow-sm bg-white p-3">
                        ...
                        <hr>
                        <a href="{{ url('checkout') }}" class="btn btn-warning w-100" style="font-weight: bold;">Checkout</a>
                    </div>
                </div>
            </div>

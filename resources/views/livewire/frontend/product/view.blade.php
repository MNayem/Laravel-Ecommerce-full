                ...
                <div class="col-md-5 mt-3">
                    <div class="bg-white border">
                        @if ($product->productImages)
                            <img src="{{ asset($product->productImages[0]->image) }}" class="w-100" style="height: 400px;" alt="Img">
                        @else
                            <h4>No Images Added for {{ $product->name }}</h4>
                        @endif
                    ...
                    <div class="product-view">
                        ...
                        <div class="mt-2">
                            <div class="input-group">
                                <span class="btn btn1" wire:click="decreamentQuantity"><i class="fa fa-minus"></i></span>
                                <input type="text" wire:model="quantityCount" value="{{ $this->quantityCount }}" readonly class="input-quantity" />
                                <span class="btn btn1" wire:click="increamentQuantity"><i class="fa fa-plus"></i></span>
                            </div>
                        </div>
                        <div class="mt-2">

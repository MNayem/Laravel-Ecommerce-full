...
<body>
        ...
        <thead>
            <tr>
                <th width="50%" colspan="2">
                    <h2 class="text-start">Nayem's Ecommerce</h2>
                   {{--  <h2>
                ...
                <th width="50%" colspan="2" class="text-end company-data">
                    ...
                    <span>Zip code : 430025</span> <br>
                    <span>Address: Nanhu Campus, Wuhan University of Technology, China</span> <br>
                </th>
            </tr>
            <tr class="bg-blue">
    ...
    <br>
    <p class="text-center">
        Thank your for shopping with N@yem's Ecommerce
    </p>
